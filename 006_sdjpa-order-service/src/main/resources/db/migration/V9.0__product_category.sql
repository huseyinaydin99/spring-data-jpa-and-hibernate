...
create table product_category (
      ...
      constraint pc_product_id_fk FOREIGN KEY (product_id) references products(id),
      constraint pc_category_id_fk FOREIGN KEY (category_id) references categories(id)
);

insert into products (description, product_status, created_date, last_modified_date)
...
insert into categories (description, created_date, last_modified_date)
VALUES ('CAT1', now(), now());
