...
public class AuthorDaoImpl implements AuthorDao {
    ...
    public Author getById(Long id) {
        ...
        try {
            ...
            ps = connection.prepareStatement("SELECT * FROM authors where id = ?");
            ps.setLong(1, id);
    ...
    public Author findAuthorByName(String firstName, String lastName) {
        ...
        try {
            connection = source.getConnection();
            ps = connection.prepareStatement("SELECT * FROM authors where first_name = ? and last_name = ?");
    ...
    public Author saveNewAuthor(Author author) {
        ...
        try {
            connection = source.getConnection();
            ps = connection.prepareStatement("INSERT INTO authors (first_name, last_name) values (?, ?)");
    ...
    public Author updateAuthor(Author author) {
        ...
        try {
            connection = source.getConnection();
            ps = connection.prepareStatement("UPDATE authors set first_name = ?, last_name = ? where author.id = ?");
            ps.setString(1, author.getFirstName());
            ps.setString(2, author.getLastName());
